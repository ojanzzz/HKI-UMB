...
@section('title', 'Tentang Sentra HKI - UM BIMA')
...
<div class="max-w-7xl mx-auto px-6 py-10 space-y-8">
    <div class="border-b border-slate-200 pb-4">
        ...
        <h2 class="text-3xl font-extrabold text-slate-900 uppercase tracking-tight mt-1">Sentra HKI Universitas Muhammadiyah Bima</h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div class="space-y-4 text-xs text-slate-700 leading-relaxed">
            <h3 class="text-lg font-extrabold text-slate-900 uppercase tracking-wide">Visi & Misi Sentra HKI UM BIMA</h3>
            <p>
                Sentra Hak Kekayaan Intelektual Universitas Muhammadiyah Bima (UM BIMA) bertugas untuk mendorong, mengelola, dan mengkomersialisasikan hasil riset dan inovasi yang dihasilkan oleh Dosen, Peneliti, dan Mahasiswa.
            </p>
            <div class="bg-emerald-50 border border-emerald-200 p-4 rounded-xl space-y-2">
                <div class="font-extrabold text-[#064E3B] uppercase">Layanan Utama Sentra HKI UM BIMA:</div>
        ...
        <div class="bg-[#064E3B] text-white p-8 rounded-2xl shadow-xl space-y-4">
            <h4 class="font-extrabold uppercase text-sm border-b border-emerald-700 pb-2">Informasi Kontak Sentra HKI</h4>
